  ...
  return (
    <svg viewBox="0 0 64 64" className={className} role="img" aria-label="League of Gangstars">
      ...
      <g transform="rotate(-35 32 32)">
        ...
        <line x1="21" y1="32" x2="43" y2="32" stroke="#b8c2cf" strokeWidth="2.2" strokeLinecap="round" />
        {[25, 29, 33, 37, 41].map((x) => (
          <line key={x} x1={x} y1="28.5" x2={x} y2="35.5" stroke="#b8c2cf" strokeWidth="2" strokeLinecap="round" />
        ))}
      </g>
    </svg>
  );
